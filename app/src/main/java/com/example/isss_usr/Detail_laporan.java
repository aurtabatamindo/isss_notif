...
//        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
    ...
    private void takeScreenShot(){
        ...
        File folder = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/Pelaporan/");
        ...
        View u = findViewById(R.id.report);

        LinearLayout z = findViewById(R.id.report);
    ...
    private void createPdf() {
        ...
        Toast.makeText(this, "Download Sukses, SdCard: Pelaporan", Toast.LENGTH_SHORT).show();
